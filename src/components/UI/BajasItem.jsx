...
const BajasItem = ({ student }) => {
  ...
  return (
    <div className='bg-neutral border-neutral-content text-neutral-content shadow-neutral flex w-full flex-col items-center justify-center space-y-4 rounded border p-6 shadow-sm transition-shadow duration-200 ease-in-out hover:shadow-lg lg:w-2xl'>
