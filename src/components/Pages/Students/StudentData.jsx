    ...
    <div className='container mx-auto mt-16 px-4'>
      ...
      <div className='mx-auto my-16 grid grid-cols-1 gap-4 space-y-8 lg:grid-cols-3'>
          ...
          <div className='card bg-neutral-content text-neutral shadow-neutral-content w-96 border shadow-sm transition-shadow duration-200 ease-in-out hover:shadow-lg'>
            <div className='card-body text-sm'>
              ...
              <div className='card-actions mt-4 justify-end'>
                <button
                  className='btn btn-warning transition-transform duration-200 ease-in-out hover:scale-105 active:scale-105'
                  onClick={() => {
                    navigate(
        ...
        {!isLoading && domicilio.domicilio && (
          <div className='card bg-neutral-content text-neutral shadow-neutral-content w-96 border text-sm shadow-sm transition-shadow duration-200 ease-in-out hover:shadow-lg'>
